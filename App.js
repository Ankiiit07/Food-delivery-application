  ...
  return (
    <div className = "header">
      <div className = "logo-container">
        ...
        <img className = "logo" src= "https://png.pngtree.com/png-vector/20190328/ourmid/pngtree-food-logo-designs-with-spoon-and-fork-png-image_879863.jpg" />
      </div>
...
const RestaurantCard = (props) => {
  ...
  return(
    <div className="res-card" style={styleCard}>
      <img 
      className="res-logo"
      alt = "res-logo" src ={"https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_660/" +  resData.data.cloudinaryImageId}></img>
      <h3>{name}</h3>
      <h4>{cuisines.join(", ")}</h4>
